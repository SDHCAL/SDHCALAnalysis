...
void processMinimizer(int nEpoch)
{
	...
	const std::string fileLocation = "/home/remi/git/SDHCAL/output/minimisation";
...
//		minimizer->ExecuteCommand("MINOS",0,0);
 ...
 hardcodedParameters.push_back( 0.0385315);
 hardcodedParameters.push_back(   4.22584e-05);
 hardcodedParameters.push_back(  -7.54657e-09);
 hardcodedParameters.push_back(0.0784297);
 hardcodedParameters.push_back(  -5.69439e-05);
 hardcodedParameters.push_back( -4.95924e-08);
 hardcodedParameters.push_back( 0.127212);
 hardcodedParameters.push_back(4.56414e-05);
 hardcodedParameters.push_back( 1.41142e-08);
